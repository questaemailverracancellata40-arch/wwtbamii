...
function flashFastestTimeStep1(){
	...
	window.GameVariables.ShowWinnerTimeout = setTimeout(flashFastestTimeStep2, 200);
}
...
function flashFastestTimeStep2(){
	...
	window.GameVariables.ShowWinnerTimeout = setTimeout(flashFastestTimeStep1, 200);
}
